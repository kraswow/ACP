...
if (isset($_GET['id']) AND ($_GET['id'] > 0) and ($_SESSION['user_id'] > 0))
    ...
    if (mysql_num_rows($res) != 1)
        ...
        if ($charview == '')
            ...
            echo '<a href="' . $charview . $cres['guid'] . '" target="_blank">' . $cres['name']
            . '</a></td>';
        echo '<td  width="80" align="center" valign="middle">' . $cres['level']
        . ' lvl</td><td width="200" align ="right" valign="middle">' . getGold($cres['money']);
        $money = $cres['money'];
        echo '</td></tr></table><br><hr>'
        . '<form method="POST"><input name="modul" value="charedit" type=hidden>';
        echo '<input name="character" value="' . (int) $_GET['id']
        . '" type=hidden><table width="500" border="0" cellspacing="0" cellpadding="0"><tr>';
        // Anti-error
        echo '<td width="50" height="30" align="center" valign="middle">'
        . '<input name=id type=radio value="1" checked ></td>'
        . '<td width="300" height="30" align="left" valign="middle">' . $txt[26] . '</td>';
        ...
        echo '<tr><td width="50" height="30" align="center" valign="middle">';
        ...
        if (($money >= $Teleport_price) OR ($_SESSION['gnom'] >= $gm_free_pay))
            ...
            echo "<img src='images/no.png' align='absmiddle'> ";
        echo '</td><td width="300" height="30" align="left" valign="middle">'
        . $txt[29] . '</td><td width="150" height="30" align="right" valign="middle">';
        if ($_SESSION['gnom'] >= $gm_free_pay)
            echo $txt[25];
        else
        ...
        if (($money >= $Gender_price) OR ($_SESSION['gnom'] >= $gm_free_pay))
            ...
            echo "<img src='images/no.png' align='absmiddle'> ";
        echo '</td><td width="300" height="30" align="left" valign="middle">'
        . $txt[233] . '</td><td width="150" height="30" align="right" valign="middle">';
        if ($_SESSION['gnom'] >= $gm_free_pay)
            echo $txt[25];
        else
        ...
        if (($money >= $Custom_price) OR ($_SESSION['gnom'] >= $gm_free_pay))
            ...
            echo "<img src='images/no.png' align='absmiddle'> ";
        echo '</td><td width="300" height="30" align="left" valign="middle">'
        . $txt[259] . '</td><td width="150" height="30" align="right" valign="middle">';
        if ($_SESSION['gnom'] >= $gm_free_pay)
            echo $txt[25];
        else
        ...
        if (($money >= $Talant_price) OR ($_SESSION['gnom'] >= $gm_free_pay))
            ...
            echo "<img src='images/no.png' align='absmiddle'> ";
        echo '</td><td width="300" height="30" align="left" valign="middle">' . $txt[261]
        . '</td><td width="150" height="30" align="right" valign="middle">';
        if ($_SESSION['gnom'] >= $gm_free_pay)
            echo $txt[25];
        else
        ...
        echo '</td></tr>';
        // Смена расы и фракции
        if (isset($ReRace_price))
            {
            echo '<tr><td width="50" height="30" align="center" valign="middle">';
            if (($money >= $ReRace_price) OR ($_SESSION['gnom'] >= $gm_free_pay))
                echo "<input name=id type=radio value='8'>";
            else
                echo "<img src='images/no.png' align='absmiddle'> ";
            echo '</td><td width="300" height="30" align="left" valign="middle">'
            . $txt['352'] . '</td><td width="150" height="30" align="right" valign="middle">';
            if ($_SESSION['gnom'] >= $gm_free_pay)
                echo $txt['25'];
            else
                echo getGold($ReRace_price);
            echo '</td></tr>';
        }
        echo '</table>';
        echo '<br><div align="center"><input type="submit" value="' . $txt[11] . '"></div></form>';
        //-----------------------------
        echo '<hr><br><table width="560" height="30" border="0" cellspacing="5" cellpadding="0">'
