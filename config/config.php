...
// Если смена расы не нужна, то просто закомментировать переменную (или удалить).
$ReRace_price = 100000000;  // Цена смены расы
//=====================================================
...
$def_exp_acc = 2;  // (дефолтовое значение поля EXPANSION у аккаунтов
                   ...
                   // 1 - tbc
                   // 2 - wotlk
$stat_old_period = '200';  // период "старости" аккаунтов для статистики.
...
//=====================================================
// Настройка дополнительной панели ссылок
// если ссылка не пуста, то на дополнительной панели появляется Иконка
// для форума, оружейки или карты
$ForumLink = '#';  // ссылка на форум
$ArmoryLink = '#'; // ссылка на Оружейку
$PortalLink = '#'; // ссылка на Основной Портал
$MapLink = '#';    // ссылка на карту
$BankLink = '';   // ссылка на банк или магазин или еще какой платный скрипт
//=====================================================
// Настройки почты. 
